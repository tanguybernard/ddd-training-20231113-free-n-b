...
@AnalyzeClasses(packages = "com.zenika.training.bc_publication")
public class MyArchTest {
    ...
    @ArchTest
    public static final ArchRule class_domain_independant_api =noClasses().that().resideInAPackage("..domain..")
